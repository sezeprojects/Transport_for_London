...
crowding_df = json_df.select("daysOfWeek")
crowding_df.printSchema()
crowding_df.show()

# # Accessing values from 'stopPoints_value' array
crowding_df = crowding_df.select(col("daysOfWeek.dayOfWeek").alias("dayOfWeek"),
...
# timeBands_df = crowding_df.select(col('timeBands.percentageOfBaseLine').alias('percentageOfBaseLine'))
# timeBands_df.show()
